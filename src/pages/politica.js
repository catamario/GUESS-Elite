...
function Politica(){
    return(
        ...
        <div className='w-full h-[400px] max-[640px]:h-[200px] relative flex items-center justify-center pl-10 pr-10 '>
            ...
            <h3 className='w-[160px] md:text-base text-xs relative text-center ml-5'>Informațiile prezentate mai jos se referă la politica site-ului. </h3>
            <img src={politicaimg} className='rounded-full relative min-[640px]:scale-75 max-[640px]:w-[100px]' />
            <h3 className='w-[160px] md:text-base text-xs relative text-center mr-7'>Aceste politici sunt create pentru a asigura o experiență sigură și consistentă pentru utilizatori, respectând norme de utilizare corectă.</h3>
            </div>
        </div>
